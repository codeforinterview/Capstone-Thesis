# Capstone-Thesis
MBA thesis on balancing speed and quality in agile product development using secondary research and thematic analysis.
...
* Study of speed vs quality trade-offs in product development
* Focus on high-risk systems such as real-time payment platforms
* Thematic analysis of secondary research (literature + industry reports)
* Evaluation of engineering practices supporting agile delivery

## Research Objectives
* Identify challenges in balancing speed and quality in agile teams
* Evaluate engineering practices that improve delivery and reliability
* Understand organizational and cultural factors affecting agile success
...
* Engineering practices like CI, automated testing, and TDD improve both speed and quality
* Organizational culture and leadership strongly influence agile success
* Poor alignment leads to technical debt and reduced product reliability
* Sustainable agility requires balancing technical and organizational factors

## Tools & Concepts Used
* Agile Frameworks: Scrum, Kanban, XP
* Engineering Practices: CI/CD, Automated Testing, TDD
...
* Industry-specific comparisons (FinTech, SaaS, e-commerce)
* Impact of AI and automation on agile development efficiency
